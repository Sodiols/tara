        ...
        - list [ref=f1e38]:
          - listitem [ref=f1e39]:
            - link "Home" [ref=f1e40] [cursor=pointer]:
              - /url: /
          - listitem [ref=f1e43]:
            - generic [ref=f1e44]: Shopping Bag
      - heading "Shopping Bag" [level=1] [ref=f1e45]
      - generic [ref=f1e46]:
        - generic [ref=f1e47]:
          - generic [ref=f1e48]:
            - link [ref=f1e49] [cursor=pointer]:
              - /url: /product/eid-black-hijab
              - img "EID black HIjab" [ref=f1e50]
            - generic [ref=f1e51]:
              - generic [ref=f1e52]:
                - link "EID black HIjab" [ref=f1e53] [cursor=pointer]:
                  - /url: /product/eid-black-hijab
                - generic [ref=f1e54]: ৳220
              - paragraph [ref=f1e55]: M / Black
              - generic [ref=f1e56]:
                - generic [ref=f1e57]:
                  - button "Decrease quantity" [ref=f1e58] [cursor=pointer]
                  - generic [ref=f1e60]: "1"
                  - button "Increase quantity" [ref=f1e61] [cursor=pointer]
                - generic [ref=f1e63]:
                  - button "Move to Wishlist" [ref=f1e64] [cursor=pointer]
                  - button "Remove" [ref=f1e65] [cursor=pointer]
          - link "Continue Shopping" [ref=f1e67] [cursor=pointer]:
            - /url: /new-arrivals
        - generic [ref=f1e68]:
          - heading "Shopping Bag" [level=2] [ref=f1e69]
          - generic [ref=f1e70]:
            - generic [ref=f1e71]: Subtotal
            - generic [ref=f1e72]: ৳220
          - generic [ref=f1e73]:
            - generic [ref=f1e74]: Delivery
            - generic [ref=f1e75]: From ৳90
          - paragraph [ref=f1e76]: The exact delivery charge depends on your delivery area and is confirmed at checkout.
          - generic [ref=f1e77]:
            - generic [ref=f1e78]: Coupon Code
            - generic [ref=f1e79]:
              - textbox "Coupon Code" [ref=f1e80]
              - button "Apply" [ref=f1e81] [cursor=pointer]
          - generic [ref=f1e82]:
            - generic [ref=f1e83]: Total
            - generic [ref=f1e84]: ৳310
          - link [ref=f1e85] [cursor=pointer]:
            - /url: /checkout
            - button "Proceed to Checkout" [ref=f1e86]
  - contentinfo [ref=f1e87]:
    - generic [ref=f1e88]:
      - generic [ref=f1e89]:
        - generic [ref=f1e90]:
          - link "TARA" [ref=f1e91] [cursor=pointer]:
            - /url: /
            - img "TARA" [ref=f1e92]
          - generic [ref=f1e93]:
            - link "Facebook" [ref=f1e94] [cursor=pointer]:
              - /url: https://facebook.com/tarabd.co
            - link "Instagram" [ref=f1e97] [cursor=pointer]:
              - /url: https://instagram.com/tarabd.co
            - link "TikTok" [ref=f1e101] [cursor=pointer]:
              - /url: https://tiktok.com/@tarabd.co
        - generic [ref=f1e104]:
          - heading "Shop" [level=3] [ref=f1e105]
          - list [ref=f1e106]:
            - listitem [ref=f1e107]:
              - link "Unready Three Piece" [ref=f1e108] [cursor=pointer]:
                - /url: /unstitched-three-piece
            - listitem [ref=f1e109]:
              - link "Two Piece" [ref=f1e110] [cursor=pointer]:
                - /url: /ready-three-piece
            - listitem [ref=f1e111]:
              - link "New Arrivals" [ref=f1e112] [cursor=pointer]:
                - /url: /new-arrivals
            - listitem [ref=f1e113]:
              - link "Accessories" [ref=f1e114] [cursor=pointer]:
                - /url: /accessories
            - listitem [ref=f1e115]:
              - link "Collection" [ref=f1e116] [cursor=pointer]:
                - /url: /collection
        - generic [ref=f1e117]:
          - heading "Customer Care" [level=3] [ref=f1e118]
          - list [ref=f1e119]:
            - listitem [ref=f1e120]:
              - link "Contact Us" [ref=f1e121] [cursor=pointer]:
                - /url: /contact
            - listitem [ref=f1e122]:
              - link "Delivery Information" [ref=f1e123] [cursor=pointer]:
                - /url: /delivery-information
            - listitem [ref=f1e124]:
              - link "Exchange Policy" [ref=f1e125] [cursor=pointer]:
                - /url: /exchange-policy
            - listitem [ref=f1e126]:
              - link "Size Guide" [ref=f1e127] [cursor=pointer]:
                - /url: /size-guide
            - listitem [ref=f1e128]:
              - link "Frequently Asked Questions" [ref=f1e129] [cursor=pointer]:
                - /url: /faq
        - generic [ref=f1e130]:
          - heading "About TARA" [level=3] [ref=f1e131]
          - list [ref=f1e132]:
            - listitem [ref=f1e133]:
              - link "Our Story" [ref=f1e134] [cursor=pointer]:
                - /url: /about
            - listitem [ref=f1e135]:
              - link "Physical Store" [ref=f1e136] [cursor=pointer]:
                - /url: /contact
            - listitem [ref=f1e137]:
              - link "Careers" [ref=f1e138] [cursor=pointer]:
                - /url: /contact
            - listitem [ref=f1e139]:
              - link "Privacy Policy" [ref=f1e140] [cursor=pointer]:
                - /url: /privacy-policy
            - listitem [ref=f1e141]:
              - link "Terms and Conditions" [ref=f1e142] [cursor=pointer]:
                - /url: /terms-and-conditions
      - generic [ref=f1e144]:
        - heading "Stay close to TARA" [level=2] [ref=f1e145]
        - paragraph [ref=f1e146]: Be the first to discover new collections, offers, and styling inspiration.
        - generic [ref=f1e147]:
          - generic [ref=f1e148]: Enter your email address
          - textbox "Enter your email address" [ref=f1e149]
          - button "Subscribe" [ref=f1e150] [cursor=pointer]
        - paragraph [ref=f1e151]: By subscribing you agree to our Privacy Policy.
      - generic [ref=f1e152]:
        - paragraph [ref=f1e153]: © 2026 TARA. All rights reserved.
        - paragraph [ref=f1e154]: Cash on Delivery
  - alert [ref=f1e155]
```
