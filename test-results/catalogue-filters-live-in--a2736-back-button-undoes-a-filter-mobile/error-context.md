...
- Name: catalogue.spec.ts >> filters live in the URL >> the back button undoes a filter
- Location: e2e\catalogue.spec.ts:34:7
...
Call log:
  - waiting for getByRole('checkbox', { name: /on sale/i }).first()
