...
export const metadata: Metadata = {
  title: "Three Piece",
  description:
    "Shop three piece sets from TARA — kameez, bottom and dupatta together, in fabrics chosen for Bangladesh's weather and finished for everyday wear.",
  alternates: { canonical: `${siteConfig.url}/three-piece` },
};
